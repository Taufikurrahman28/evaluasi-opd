...
@section('content')
    <form action="{{ route('periodik.update', $data->id ) }}" method="post">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('mulai') is-invalid @enderror" id="mulai"
                                name="mulai" value={{ old('mulai', $data->mulai) }}>
                            @error('mulai')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('selesai') is-invalid @enderror" id="selesai"
                                name="selesai" value={{ old('selesai', $data->selesai) }}>
                            @error('selesai')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_aktif" id="aktif"
                                value="1" @checked(old('is_aktif', $data->is_aktif === 1))>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_aktif" id="tidak_aktif"
                                    value="0" @checked(old('is_aktif', $data->is_aktif === 0))>
